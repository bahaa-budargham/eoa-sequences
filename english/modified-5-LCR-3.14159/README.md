...
Each file in `terms/` contains the pre-convergence sequence for one distinct group in this encoding. Each public file contains only the first 24 terms.
...
- Only the first 24 terms are public. The complete sequence and its rational generating function are available to qualified researchers under the collaboration terms described in EOA Part I, Section 2.
...
Only the outputs are published here. Public release is limited to the first 24 terms. Full sequences and rational functions are withheld and shared only under the agreed collaboration terms. The deterministic operator that generates these sequences is not disclosed. It is available to qualified researchers under the terms described in EOA Part I, Section 2.
...
For access to the full sequence and rational function, contact bdarghamneurolabs@gmail.com under the collaboration terms in EOA Part I, Section 2.
